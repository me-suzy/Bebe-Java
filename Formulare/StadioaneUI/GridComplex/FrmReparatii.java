...
public class FrmReparatii extends javax.swing.JFrame {
   ...
   Connection conn;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cbocoddiv = new javax.swing.JComboBox();
        ...
        cancelrepar.setBackground(new java.awt.Color(51, 255, 51));
        cancelrepar.setForeground(new java.awt.Color(255, 51, 51));
        ...
        txtidech.setBackground(new java.awt.Color(204, 204, 204));
        txtidech.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtidech.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jPanel1.add(txtidech, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 120, 30));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 16));
        jLabel3.setForeground(new java.awt.Color(0, 0, 51));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Cod Divizie");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 120, 40));

        cbocoddiv.setBackground(new java.awt.Color(204, 204, 204));
        cbocoddiv.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jPanel1.add(cbocoddiv, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 20, 250, 30));

        txtnrjuc.setBackground(new java.awt.Color(204, 204, 204));
        txtnrjuc.setEditable(false);
        txtnrjuc.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtnrjuc.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jPanel1.add(txtnrjuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 70, 250, 30));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14));
        jLabel5.setForeground(new java.awt.Color(51, 0, 0));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Nr Jucatori");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 60, 150, 40));
        ...
        jPanel1.add(jFormattedTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 120, 30));
  ...
  /*     java.text.SimpleDateFormat formatData=new java.text.SimpleDateFormat("dd/MM/yyyy");
    ...
    private javax.swing.JComboBox cbocoddiv;
